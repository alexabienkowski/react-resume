...
export const homePageMeta: HomepageMeta = {
    ...
    description: "Example site built with Alexa's react resume template",
};
    ...
    description: (
        <>
            <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
                I'm a Connecticut based <strong className="text-stone-100">Software Engineer</strong>, currently working
                at <strong className="text-stone-100">my Dad's kitchen</strong>.
...
export const testimonial: TestimonialSection = {
    ...
    testimonials: [
        // {
        //     name: 'Me',
        //     text: 'I think I am very good.',
        //     image: 'https://cdn1.vectorstock.com/i/1000x1000/53/95/thumb-up-emoticon-vector-1075395.jpg',
        // },
        {
            name: 'Borat',
            text: 'Very Nice!',
